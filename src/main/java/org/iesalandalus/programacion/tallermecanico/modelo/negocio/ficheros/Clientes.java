...
public class Clientes implements IClientes {
    ...
    protected static Clientes getInstancia() { // es preferible hacerlo asi para evitar cargas inecesarias de recurso PATRON SINGLETON
        if (instancia == null) {
    ...
    private void procesarDocumentoXml(org.w3c.dom.Document documentoXml) {
    ...
    public void terminar() {
        org.w3c.dom.Document documentoXml = crearDocumentoXml();
        UtilidadesXml.escribirDocumentoXml(documentoXml, FICHERO_CLIENTES);
    }

    private org.w3c.dom.Document crearDocumentoXml() {
